...
chapters = load_chapters('../public/nils-holgersson.txt')
...
for message in source.split('\n'):
    ...
    print 'Expected  text: %s' % '11:3:77 3:14:9 2:9:15 2:3:22 2:2:26 3:16:28 2:3:22 46:73:41'

    decrypted_text = decrypt('5:27:9 2:9:15 2:12:18 3:3:36 1:1:8 22:12:45 1:1:4 3:3:36 4:27:11', chapters)
