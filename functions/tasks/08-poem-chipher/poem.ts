...
export default {
  ...
  indata: [
    ...
    'Poetryusesformsandconventionstosuggestdifferentialinterpretationsofwordsortoevokeemotiveresponses.Devicessuchasassonancealliterationonomatopoeiaandrhythmmayconveymusicalorincantatoryeffects',
    'Somepoetrytypesareuniquetoparticularculturesandgenresandrespondtocharacteristicsofthelanguageinwhichthepoetwrites.ReadersaccustomedtoidentifyingpoetrywithDanteGoetheMickiewiczorRumimaythinkofitaswritteninlinesbasedonrhymeandregularmeter',
    'AristotlesworkwasinfluentialthroughouttheMiddleEastduringtheIslamicGoldenAgeaswellasinEuropeduringtheRenaissance.Laterpoetsandaestheticiansoftendistinguishedpoetryfromanddefineditinoppositiontoprosewhichtheygenerallyunderstoodaswritingwithaproclivitytologicalexplicationandalinearnarrativestructure',
